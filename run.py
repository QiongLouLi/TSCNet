...
parser.add_argument('--model', type=str, required=False, default='TSCNet',
                    help='model name, options: [TSCNet, Informer, Autoformer, ...]')

# HL_loss
name, n, rate = 'weather', 21, 0.0003
...
# parser.add_argument('--data_path', type=str, default=f'{name}.npz', help='data file')
# parser.add_argument('--data_path', type=str, default=f'{name}.h5', help='data file')
...
parser.add_argument('--learning_rate', type=float, default=rate, help='optimizer learning rate')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_pl{}_seed{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
